...
if (isset($_POST['btn-insert'])):
    insert($_POST['nome'], $_POST['observacao'], $_POST['phone']);
endif;
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/app.css" <!-- Favicons -->
...
<body cz-shortcut-listen="true">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        <h4>Desafio:</h4>
                        <p class="text-body-primary">O desafio consiste em realizar um C.R.U.D utilizando-se PHP e
                        ...
                        <p class="text-body-primary">O desafio consiste em criar um formulario de cadastro de um
                            clientes, com os campos de nome e telefone, possuindo as funcionalidades de cadastrar,
        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <h3 class="fw-light">Saulo S. Bonfim</h3>
                ...
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome"
                            placeholder="Fulano da Silva Santos" value="">
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label">Telefone:</label>
                        <input type="number" class="form-control" id="phone" name="phone" placeholder="(71) 3241-3010"
                            value="">
                    </div>
                    <div class="mb-3">
                        <label for="observacao" class="form-label">Observação:</label>
                        <textarea class="form-control" id="observacao" name="observacao"
                            placeholder="Alguma Observação Aqui !" rows="3" value=""></textarea>
                    </div>

                    <div class="mb-3">
                        <button type="submit" name="btn-insert" class="btn btn-success mb-3">Cadastrar</button>
                    </div>
                </form>
            </div>
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">(71) 3241-3010</p> <!-- Placeholder still -->
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                        <div class="btn-group">
                                            <a type="button" class="btn btn-sm btn-primary" href="#">Editar</a>
                                            <a type="button" class="btn btn-sm btn-danger" href="delete.php">Excluir</a>
                                        </div>
    ...
    <footer class="text-body-secondary py-5">
        <div class="container">
            ...
            <p class="mb-0">Objetivo Sistemas
                <?= date('Y'); ?>
            </p>
        </div>
    </footer>
